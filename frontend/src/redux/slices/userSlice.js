...
export const userSlice = createSlice({
    ...
    extraReducers: (builder) => {
       ...
       }).addCase(updateProfile.pending, (state) => { // loading
        state.loading = true; 
        state.error = false;

       }).addCase(updateProfile.fulfilled, (state, action) => { // sucess
        state.loading = false;  
        state.success = true;  
        state.error = null; 
        state.user = action.payload;
       ...
       }).addCase(updateProfile.rejected, (state, action) => {  // error
        console.log(state, action);
        state.loading = false; 
        state.error = action.payload;
        state.user = {};

       }).addCase(getUserDetails.pending, (state) => { // loading
        state.loading = true; 
        state.error = false;

    }).addCase(getUserDetails.fulfilled, (state, action) => { // sucess
        state.loading = false;  
        state.success = true;  
        state.error = null; 
        state.user = action.payload;
